...
(function() {
  ...
  ElementsRenderer = (function() {
    ...
    ElementsRenderer.prototype.createFolderLi = function(node) {
      ...
      escaped_featured = this.escapeIfNecessary(node.featured);
      escaped_superfeatured = this.escapeIfNecessary(node.superfeatured);
      if (node.is_open) {
    ...
    ElementsRenderer.prototype.createNodeLi = function(node) {
      ...
      div.appendChild(title_span);
      if (escaped_featured == 1) {
        title_span.innerHTML = escaped_name + '<img src="'+baseRoot + '/mng/img/star.svg" alt="">';
      }else{
        title_span.innerHTML = escaped_name;
      }
      return li;
